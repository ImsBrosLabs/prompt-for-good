    ...
    >
      ...
      >
        ...
        <Box sx={{ py: { xs: 1.5, md: 6 }, maxWidth: 480 }}>
          ...
          >
            Configure the runner before it works.
          </Typography>
        </Box>
      ...
      >
        ...
        >
          ...
          <Typography sx={{ mb: 4, color: "text.secondary", fontSize: 14 }}>
            Enter the local admin token configured for this runner.
          </Typography>
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton
                      aria-label={
                        showAdminKey
                          ? "Hide local admin token"
                          : "Show local admin token"
                      }
                      edge="end"
